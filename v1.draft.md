...
The machine-readable form of this description is using [JSON-LD](https://json-ld.org/) format and can be found [here](https://raw.githubusercontent.com/bloxmove-com/bloxmove-vocab/v1-draft).
...
```
{
    "credential": {
        "@context": [
            ...
            "https://raw.githubusercontent.com/bloxmove-com/bloxmove-vocab/v1-draft"
        ],
        "type": [
